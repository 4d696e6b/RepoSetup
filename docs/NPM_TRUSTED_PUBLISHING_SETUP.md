...
The npm **username** is whatever account owns `reposetup` after the first publish. Do not assume it equals the GitHub login.
...
## After `reposetup` exists on npm

1. Open `https://www.npmjs.com/package/reposetup`.
...
8. Confirm `npm view reposetup@version version`.
