...
**npm is not published in this GitHub tag.** Intended command after publication: `npx reposetup-cli`. From a clone: `pnpm install && pnpm build && node packages/cli/dist/bin.js --help`.
