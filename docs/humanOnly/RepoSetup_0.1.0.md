...
**For humans.** This is the first **public GitHub** release of RepoSetup. It is an early-stage `0.1.0`. It is not `1.0.0`. The public npm name is `rsetup`. It is **not on npm** until the maintainer publishes from `packages/cli`.
